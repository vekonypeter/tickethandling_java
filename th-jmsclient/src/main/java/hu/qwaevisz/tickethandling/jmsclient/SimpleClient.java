...
public class SimpleClient {
	...
	public static void main(String[] args) throws NamingException, JMSException {
		...
		final Destination destination = (Destination) context.lookup("jms/queue/ticketingqueue");
		...
		final TextMessage textMessage = session.createTextMessage("AES-324,Mr Message Bean,MEDIUM,Very big,Nope,Please take care of this");
